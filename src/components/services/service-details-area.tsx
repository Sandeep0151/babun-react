          ...
          <div className="col-xxl-9 col-lg-8 order-lg-last">
            <div className="details-meta ps-xxl-5 ps-xl-3">
              ...
              <div className="img-meta mb-60 lg-mb-40">
                <img src="/static/assets/images/media/img_35.jpg" alt="service_img" className="lazy-img w-100 rounded-4"/>
              </div>
              ...
              <div className="line-wrapper pb-30 mt-60 lg-mt-40 mb-70 lg-mb-40">
                <div className="row">
                  <div className="col-md-4 wow fadeInUp">
                    <CardItem icon="/static/assets/images/icon/icon_81.svg" title='Collect Doc' subtitle='We collect require documents & send for check' />
                  </div>
                  <div className="col-md-4 wow fadeInUp" data-wow-delay="0.1s">
                  <CardItem icon="/static/assets/images/icon/icon_82.svg" title='Check & Finalize' subtitle='We check the documents & send for final approval' />
                  </div>
                  <div className="col-md-4 wow fadeInUp" data-wow-delay="0.2s">
                  <CardItem icon="/static/assets/images/icon/icon_83.svg" title='Approved' subtitle='After approve you ready to use your accounts' />
                  </div>
                </div>
              </div>
              <div className="light-bg-deep quote-wrapper position-relative mb-60 lg-mb-40">
                <div className="d-xl-flex align-items-start">
                  <img src="/static/assets/images/icon/icon_84.svg" alt="icon" className="lazy-img icon"/>
                ...
                <img src="/static/assets/images/assets/ils_03.svg" alt="ils_icon" className="lazy-img shapes shape_01"/>
              </div>
            ...
            <aside className="md-mt-40">
              <div className="service-nav-item">
                <ul className="style-none">
                  <ServiceNav icon="/static/assets/images/icon/icon_72.svg" title='Multiple Accounts' active={true}/>
                  <ServiceNav icon="/static/assets/images/icon/icon_73.svg" title='Loan Facility'/>
                  <ServiceNav icon="/static/assets/images/icon/icon_74.svg" title='Expense Track'/>
                  <ServiceNav icon="/static/assets/images/icon/icon_75.svg" title='DPS & FDR'/>
                  <ServiceNav icon="/static/assets/images/icon/icon_76.svg" title='International Account'/>
                  <ServiceNav icon="/static/assets/images/icon/icon_77.svg" title='Saving Account'/>
                  <ServiceNav icon="/static/assets/images/icon/icon_78.svg" title='Agent Banking'/>
                  <ServiceNav icon="/static/assets/images/icon/icon_79.svg" title='Credit & Debit Cards'/>
                  <ServiceNav icon="/static/assets/images/icon/icon_80.svg" title='Consultation'/>
                </ul>
              </div>
