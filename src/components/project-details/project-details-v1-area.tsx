...
// list item
function ListItem({ icon, text, sm_text }: { icon: string; text: string; sm_text: string }) {
  return (
    <li className="d-flex">
      ...
      <div className="container">
        ...
        <div className="social-share mt-130 sm-mt-80 d-flex justify-content-end">
          <ul className="style-none d-flex align-items-center">
            ...
            <li><NavLink to="#"><i className="bi bi-dribbble"></i></NavLink></li>
            <li><NavLink to="#"><i className="bi bi-instagram"></i></NavLink></li>
          </ul>
        </div>
